...
<div class="middle2">
<h2 align="center">DAFTAR KATEGORI BUKU</h2><br>
<div align="center">
</div>
<ul>
<?php
...
if(!$conn)
    ...
    $tsql = "SELECT Distinct(NamaKategori) FROM Kategori";
    ...
    while($obj = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)){
        echo "<li><a href=\"http://localhost/perpustakaan/select_kategori.php?NamaKategori=".$obj["NamaKategori"]."\">".$obj["NamaKategori"]."</li>";
    }
?>
</ul>
